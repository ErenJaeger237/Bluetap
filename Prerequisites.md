...
Step 1: Start the Gateway (The "Brain")
...
Step 2: Start Storage Nodes (The "Muscle")
...
Upload a file using the User Dashboard.

Check the Admin Dashboard to see the file recorded.

Kill Node A (Press Ctrl+C in Terminal 2).

Refresh the Admin Dashboard: Node A should turn 🔴 OFFLINE.

Go back to the User Dashboard and click Retrieve.

The system will automatically failover and download the file from Node B.
